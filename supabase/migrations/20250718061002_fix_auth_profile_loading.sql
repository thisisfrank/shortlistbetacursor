-- Fix authentication profile loading issues
-- This addresses the PGRST116 error and 406 Not Acceptable responses

-- Step 1: Ensure RLS is disabled on user_profiles to prevent policy conflicts
