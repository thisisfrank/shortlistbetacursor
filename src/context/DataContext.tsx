  ...
  const updateJob = (jobId: string, updates: Partial<Job>) => {
    return new Promise<Job | null>(async (resolve, reject) => {
      try {
        ...
        if (updates.sourcerId !== undefined) dbUpdates.sourcer_id = updates.sourcerId; // Fixed: sourcer_name -> sourcer_id
        ...
        const updatedJob: Job = {
          ...
          sourcerId: updatedJobData.sourcer_id || null, // Fixed: sourcer_name -> sourcer_id
